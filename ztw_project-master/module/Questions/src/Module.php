...
class Module implements ConfigProviderInterface
{
        ...
        return [
            'factories' => [
                Model\QuestionsTable::class        => function ($container) {
                    $tableGateway = $container->get('Model\QuestionsTableGateway');
                    
                    return new Model\QuestionsTable($tableGateway);
                },
                'Model\QuestionsTableGateway' => function ($container) {
    ...
    public function getControllerConfig()
    {
        return [
            'factories' => [
                Controller\QuestionsController::class => function ($container) {
                    return new Controller\QuestionsController(
